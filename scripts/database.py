...
class DatabaseManager:
    ...
    def _init_products_table(self):
        ...
        if not os.path.exists(self.products_file):
            ...
            demo_products = [
                ('MacBook Pro 14"', 'Ordinateur portable Apple avec puce M3 Pro, 18Go RAM, 512Go SSD. Écran Liquid Retina XDR.', '2499.99', '15', 'Informatique', 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400', '2'),
                ('iPhone 15 Pro', 'Smartphone Apple dernière génération avec titane, puce A17 Pro, caméra 48MP.', '1199.99', '25', 'Smartphones', 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=400', '2'),
                ('Sony WH-1000XM5', 'Casque audio sans fil avec réduction de bruit active premium, autonomie 30h.', '379.99', '30', 'Audio', 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400', '2'),
                ...
                ('Nintendo Switch OLED', 'Console de jeu portable avec écran OLED 7", dock et Joy-Con inclus.', '349.99', '40', 'Gaming', 'https://images.unsplash.com/photo-1578303512597-81e6cc155b3e?w=400', '3'),
                ('Dyson V15 Detect', 'Aspirateur sans fil intelligent avec laser pour détecter la poussière microscopique.', '699.99', '12', 'Maison', 'https://images.unsplash.com/photo-1558317374-067fb5f30001?w=400', '3'),
                ...
                ('Canon EOS R6 Mark II', 'Appareil photo hybride plein format 24.2MP, vidéo 4K 60fps, stabilisation.', '2499.99', '8', 'Photo', 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400', '3'),
                ('AirPods Pro 2', 'Écouteurs sans fil Apple avec réduction de bruit adaptative et audio spatial.', '279.99', '50', 'Audio', 'https://images.unsplash.com/photo-1600294037681-c80b4cb5b434?w=400', '2'),
                ('Dell UltraSharp 27"', 'Moniteur 4K IPS professionnel avec calibration usine, USB-C 90W.', '599.99', '15', 'Informatique', 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=400', '3'),
            ]
