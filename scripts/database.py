...
class DatabaseManager:
    ...
    def _init_users_table(self):
        ...
        Crée des comptes par défaut si la table est vide.
        """
        if not os.path.exists(self.users_file):
            ...
            self.create_user('admin@shoppro.com', 'admin123', 'Admin', 'System', 'admin')
            self.create_user('vendeur@shoppro.com', 'vendeur123', 'Jean', 'Vendeur', 'seller')
            self.create_user('client@shoppro.com', 'client123', 'Marie', 'Cliente', 'client')
            
            print("[DB] Table users créée avec comptes par défaut")
    ...
    def _init_products_table(self):
        ...
        if not os.path.exists(self.products_file):
            ...
            demo_products = [
                ('MacBook Pro 14"', 'Ordinateur portable Apple avec puce M3 Pro, 18Go RAM, 512Go SSD.', '2499.99', '15', 'Informatique', 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400', '2'),
                ('iPhone 15 Pro', 'Smartphone Apple dernière génération avec titane, puce A17 Pro.', '1199.99', '25', 'Smartphones', 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=400', '2'),
                ('Sony WH-1000XM5', 'Casque audio sans fil avec réduction de bruit active, autonomie 30h.', '379.99', '30', 'Audio', 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400', '2'),
                ('Samsung Galaxy Tab S9', 'Tablette Android haut de gamme avec écran AMOLED 11", S Pen inclus.', '899.99', '20', 'Tablettes', 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=400', '2'),
                ('Nintendo Switch OLED', 'Console de jeu portable avec écran OLED 7", dock inclus.', '349.99', '40', 'Gaming', 'https://images.unsplash.com/photo-1578303512597-81e6cc155b3e?w=400', '2'),
                ('Dyson V15 Detect', 'Aspirateur sans fil avec laser pour détecter la poussière.', '699.99', '12', 'Maison', 'https://images.unsplash.com/photo-1558317374-067fb5f30001?w=400', '2'),
                ('Montre Garmin Fenix 7', 'Montre GPS multisports avec cartes TopoActive, autonomie 18 jours.', '699.99', '18', 'Sport', 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400', '2'),
                ('Canon EOS R6 Mark II', 'Appareil photo hybride plein format 24.2MP, vidéo 4K 60fps.', '2499.99', '8', 'Photo', 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400', '2'),
            ]
    ...
    def create_order(self, user_id: str, shipping_address: str) -> Optional[Dict]:
        ...
        for item in cart:
            ...
            self.update_product(product['id'], stock=str(max(0, new_stock)))
    ...
    def update_order_status(self, order_id: str, status: str) -> bool:
        ...
        for order in orders:
            if order['id'] == order_id:
                ...
                print(f"[DB] Commande {order_id} mise à jour: {status}")
                return True
        return False
    ...
    def get_statistics(self) -> Dict:
        """Récupère des statistiques pour le dashboard admin."""
        users = self._read_csv(self.users_file)
        products = self._read_csv(self.products_file)
        orders = self._read_csv(self.orders_file)
        ...
        return {
            ...
            'orders': {
                ...
                'revenue': f"{sum(float(o['total']) for o in orders):.2f}"
            }
        }
